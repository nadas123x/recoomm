...
def buy(request):
    ...
    filename=r"c:/Users/Dell/recomm/DJANGO/minor/website/csvfile/recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        ...
        df=pd.read_csv(r'C:/Users/Dell/recomm/DJANGO/minor/website/csvfile/recent_activity.csv')
        df1=pd.read_csv(r'C:/Users/Dell/recomm/DJANGO/minor/website/dataset.csv')
