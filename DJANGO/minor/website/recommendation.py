#content based method, sa dép de ton profil on te recommande des plats similaires.
...
df = pd.read_csv(r'C:/Users/DeLL/recomm/DJANGO/minor/website/dataset.csv')
...
def Recommend(request):
    ...
    if request.user.is_authenticated:
        class Recommender:
            ...
            def __init__(self):
                self.df = pd.read_csv(r'C:/Users/DeLL/recomm/DJANGO/minor/website/dataset.csv')
