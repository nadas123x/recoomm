...
def Recommend(request):
    if request.user.is_authenticated:   
        ...
        profiles = pd.read_csv(r'C:/Users/Dell/recomm/DJANGO/minor/website/csvfile/user_Profiles.csv') # profiles of all users
        recent_activity = pd.read_csv(r'C:/Users/Dell/recomm/DJANGO/minor/website/csvfile/recent_activity.csv') # recent activities of current user (meals liked,rated,searched,Purchased)
        dataset = pd.read_csv(r'C:/Users/DeLL/recomm/DJANGO/minor/website/dataset.csv') # main dataset
